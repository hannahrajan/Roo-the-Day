...
public enum AkAudioAPI {
  ...
  ///  Add this bit to opt into the Dolby Atmos API for 3D audio where available. On Android platforms where Dolby Car eXperience (DCX) is present, when AAudio is selected as an audio API and AkAudioAPI_DolbyAtmos flag is enabled, the system sink will attempt to retrieve the preferred DCX channel configuration from the Android audio platform and use it.
